...
# --- Mock Data ---
MENU = [
    {"id": "latte", "name": "Caffè Latte", "price": 4.25, "description": "Rich espresso with steamed milk.", "image_url": "https://images.unsplash.com/photo-1541167760496-162955ed8a9f?w=300&h=300&fit=crop"},
    ...
    {"id": "spring-latte", "name": "Honey Lavender Latte", "price": 5.45, "description": "🌸 Spring Special: Creamy latte with hints of honey and floral lavender.", "image_url": "https://images.unsplash.com/photo-1593444202241-2421aa9ed924?q=80&w=300&h=300&auto=format&fit=crop"},
]
